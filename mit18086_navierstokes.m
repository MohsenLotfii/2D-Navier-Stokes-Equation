...
lx = 1;       % width of box
ly = 1;       % height of box
nx = 160;      % number of x-gridpoints
ny = 160;      % number of y-gridpoints
...
% pressure correction
   ...
   P = reshape(p,nx,ny);
   U = U-diff(P)/hx; u_num=U(80,:)
   V = V-diff(P')'/hy; v_num=V(:,80)
